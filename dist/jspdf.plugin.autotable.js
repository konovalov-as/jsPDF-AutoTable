      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Table = /** @class */ (function() {
          ...
          Table.prototype.callCellHooks = function(
            ...
            for (
              ...
              if (
                handler(new HookData_1.CellHookData(cell, row, column)) ===
                false
              ) {
                return false
              }
        ...
        var Row = /** @class */ (function() {
          ...
          Row.prototype.getMinimumRowHeight = function() {
            ...
            return state_1
              .default()
              .table.columns.reduce(function(acc, column) {
        ...
        var Cell = /** @class */ (function() {
          ...
          Cell.prototype.getContentHeight = function() {
            ...
            var fontHeight =
              (this.styles.fontSize / state_1.default().scaleFactor()) *
              config_1.FONT_ROW_RATIO
            ...
            for (var i_1 = 0; i_1 < row.cells.length; i_1++) {
              ...
              if (includeHidden || style.display !== 'none') {
                var cellStyles = useCss
                  ? cssParser_1.parseCss(cell, state_1.default().scaleFactor())
                  : {}
                resultRow.push({
        ...
        function printRow(row) {
          ...
          for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
            ...
            if (cell.styles.valign === 'top') {
              ...
              cell.textPos.y =
                table.cursor.y + cell.height - cell.padding('bottom')
            } else {
      ...
      /***/ function(module, exports, __webpack_require__) {
            ...
            for (var _b = 0, _c = table.columns; _b < _c.length; _b++) {
              ...
              if (cell.styles.overflow === 'linebreak') {
                ...
                cell.text = state_1
                  ...
                  .doc.splitTextToSize(
                    cell.text,
                    textSpace + 1 / (state_1.default().scaleFactor() || 1),
        ...
        function distributeWidth(
          ...
          for (var i = 0; i < autoColumns.length; i++) {
            ...
            for (
              var _i = 0, _a = state_1.default().table.allRows();
              _i < _a.length;
              _i++
            ) {
              var row = _a[_i]
            ...
            if (suggestedWidth < column.minWidth || hasCustomWidth) {
              ...
              column.width =
                column.minWidth + 1 / state_1.default().scaleFactor()
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function parseInput(args) {
          ...
          for (
            ...
            for (
              var _c = 0, _d = Object.keys(table.cellHooks);
              _c < _d.length;
              _c++
            ) {
              var hookName = _d[_c]
        ...
        function parseContent(table) {
          ...
          var _loop_2 = function(sectionName) {
            ...
            if (
              ...
              var sectionRow = generateSectionRowFromColumnData(
                table,
                sectionName
              )
              if (sectionRow) {
                ...
                if (
                  ...
                  if (columnSpansLeft === 0) {
                    ...
                    if (Array.isArray(rawRow)) {
                      rawCell =
                        rawRow[
                          column.index - colSpansAdded - skippedRowForRowSpans
                        ]
                    } else {
        ...
        function generateSectionRowFromColumnData(table, sectionName) {
          ...
          table.columns.forEach(function(col) {
            ...
            if (sectionName === 'head') {
              var val =
                columnData && columnData.header ? columnData.header : columnData
              if (val) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function default_1(allOptions) {
          var _loop_1 = function(settings) {
            ...
            for (
              var _i = 0,
                _a = ['styles', 'bodyStyles', 'headStyles', 'footStyles'];
              _i < _a.length;
              _i++
            ) {
              var styleProp = _a[_i]
            ...
            for (
              var _b = 0, _c = Object.keys(columnStyles);
              _b < _c.length;
              _b++
            ) {
              var key = _c[_b]
